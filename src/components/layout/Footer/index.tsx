            ...
            <div className="mt-5 flex items-center gap-3">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 text-gray-400 transition-all hover:bg-white/10 hover:text-white hover:scale-110"
                >
              ...
              <a
                ...
                aria-label="WhatsApp"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-whatsapp/20 text-whatsapp transition-all hover:bg-whatsapp/30 hover:scale-110"
              >
